...
echo "<div>";
echo "<p>Soy un mensaje secreto</p>";
echo "<p>usuario Logueado: " . $_SESSION['usuario'] . "</p> <br>";
echo "<div>";
?>
...
<div>
    <p>Hola mundo, soy un párrafo HTML que solamente pueden ver los usuarios logueados</p>
